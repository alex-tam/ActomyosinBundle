...
# Procedure: add to network stats structure and function, 
# compute, 
# add to pre-allocate and compute network statistics in actomyosin_network, 
# preallocate and write in main.jl
